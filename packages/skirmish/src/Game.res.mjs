...
function sceneLoaded() {
  ...
  let pikachu = Pkmn$Skirmish.make(GameContext$Skirmish.k, 25, 12, Thundershock$Skirmish.move, QuickAttack$Skirmish.move, undefined, undefined, false);
  let charmander = Pkmn$Skirmish.make(GameContext$Skirmish.k, 4, 5, Ember$Skirmish.move, undefined, undefined, undefined, true);
  Player$Skirmish.make(charmander);
  EnemyAI$Skirmish.make(GameContext$Skirmish.k, pikachu, charmander);
...
function scene() {
  ...
  Pkmn$Skirmish.load(GameContext$Skirmish.k, 4);
  Pkmn$Skirmish.load(GameContext$Skirmish.k, 25);
